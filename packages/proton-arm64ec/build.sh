...
#TERMUX_PKG_DEPENDS="fontconfig, libdrm, freetype, krb5, libandroid-spawn, libandroid-shmem, libc++, libgmp, libxcb, libxcomposite, libxcursor, libxfixes,libxrender, pulseaudio, sdl2, vulkan-loader, xorg-xrandr"
